...
class IndexController extends HomeController {
    ...
    public function index(){
        ...
        $hot_product_list  =M('recommend b')->join('onethink_picture p ON p.id = b.picture_id')->join('onethink_item i ON i.id = b.value')->where(['b.type'=>3,'b.status'=>1])->field('b.value,p.path,i.name,i.description,b.title,b.desc')->order('b.level desc,b.id desc')->select();
