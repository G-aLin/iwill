...
class PromotionController extends AdminController {
    ...
    public function index(){
        ...
        $list = $this->lists('promotion', $map,'id desc');
    ...
    public function setStatus($model=''){
      $status = I('get.status');
      $status = $status == 1 ? 0 : 1;
      $this->editRow('promotion', array('status'=>$status), array('id'=>I('get.id')));
    }
    ...
    public function edit(){
        ...
        // 获取详细数据
        $data  =M('promotion')->where(['id'=>$id])->find();
